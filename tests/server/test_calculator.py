...
class Test_calculator(unittest.TestCase):
    ...
    def test_get_voter_count_by_gender(self):
        self.sqlite.execute_query("UPDATE Users SET gender = 'female' WHERE user_id < 50")
    ...
    def test_get_voter_count_by_age(self):
        ...
        self.sqlite.execute_query("UPDATE Users SET birth_date = '"+ eighteen_years_ago.strftime("%d/%m/%Y")
        ...
        self.sqlite.execute_query("UPDATE Users SET birth_date = '"+ Twentysix_years_ago.strftime("%d/%m/%Y")
        ...
        self.sqlite.execute_query("UPDATE Users SET birth_date = '"+ Thirtysix_years_ago.strftime("%d/%m/%Y")
        ...
        self.sqlite.execute_query("UPDATE Users SET birth_date = '"+ fourtysix_years_ago.strftime("%d/%m/%Y")
        ...
        self.sqlite.execute_query("UPDATE Users SET birth_date = '"+ fiftysix_years_ago.strftime("%d/%m/%Y")
        ...
        self.sqlite.execute_query("UPDATE Users SET birth_date = '"+ sixtysix_years_ago.strftime("%d/%m/%Y")
