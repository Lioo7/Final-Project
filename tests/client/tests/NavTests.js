...
(async function NavTests() {
  ...
  try {
    ...
    if (title !== 'Voting') {
      console.log('------------ Voting page navigation test failed ------------');
    } else {
      console.log('------------ Voting page navigation test passed ------------');
    }
    ...
    if (title !== 'Information') {
      console.log('------------ Information page navigation test failed ------------');
    } else {
      console.log('------------ Information page navigation test passed ------------');
    }
    ...
    title = await driver.getTitle();
    if (title !== 'Dashboard') {
      console.log('------------ Dashboard page navigation test failed ------------');
    } else {
      console.log('------------ Dashboard page navigation test passed ------------');
    }
    ...
    title = await driver.getTitle();
    if (title !== 'Results') {
      console.log('------------ Results page navigation test failed ------------');
    } else {
      console.log('------------ Results page navigation test passed ------------');
    }
