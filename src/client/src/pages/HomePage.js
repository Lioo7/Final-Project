        ...
        <Box sx={{ width: '75%',mt: '20px', mb: '100px'  }} style={contentStyles}>
          ...
          >
            <CardContent>
              ...
              >
                הצגת תקציב העם: עוצמת האזרחים לעצב את העתיד.
                <br />
                ברוכים הבאים לתקציב העם, פלטפורמה פורצת דרך המעמידה את כוח קבלת ההחלטות בידי העם. האתר שלנו מספק גישה
                כוללת ודמוקרטית לקביעת אופן הקצאת תקציבי המדינה. אנחנו מאמינים שכל אזרח צריך להביע דעה בעיצוב עתיד
                הקהילה שלו, וזה בדיוק מה שאנחנו מציעים. בתקציב העם, אנו מבינים שלכל אדם יש סדרי עדיפויות ודאגות
                ייחודיים. לכן אנו מספקים מגוון מקיף של פרויקטים ויוזמות, כל אחד מלווה במידע מפורט, מבטיח שקיפות וקבלת
                החלטות מושכלת.
          ...
          >
            <CardContent>
              ...
              >
                {' '}
                הישארו מעודכנים וצפו בתוצאות האחרונות כדי לראות את ההשפעה של ההצבעה שלך על חלוקת התקציב הכוללת. הצטרפו
                עוד היום לתקציב העם ותשפיעו. ביחד, בואו נעצב עתיד טוב יותר, ונגרום למדינה שלנו לפרוח.
              </Typography>
            </CardContent>
          </Card>
        </Box>
